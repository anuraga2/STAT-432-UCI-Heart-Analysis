...
We see that the three curves intersect at `0.52` threshold. Based on this we will be predicting any entry with probability __> 0.52__ as __1__ and __< 0.52__ as __0__
...
log_ridge_plot
```
Based on the chart above we observe that accuracy hits a __maximum of ~78%__ around `0.54` threshold. Lets print the confusion Matrix and accuracy of the model below.
...
Based on the chart above we observe that accuracy hits a __maximum of ~78%__ around `0.57` threshold. Lets print the confusion Matrix and accuracy of the model below
